    ...
    return (
      ...
      >
        ...
        <div className="relative w-24 h-24 rounded-lg overflow-hidden bg-secondary/20 shrink-0">
          ...
          {!isAvailable && (
            <div className="absolute inset-0 bg-foreground/60 flex flex-col items-center justify-center gap-0.5 rounded-lg">
              <span className="text-[10px] font-bold text-white">Out of Stock</span>
              <span className="text-[8px] text-white/80">Will arrive soon</span>
            </div>
          )}
        </div>
            ...
            <div className="flex items-center gap-1.5">
              ...
              <Button
                ...
                className={cn(
                  ...
                  isAdding && "cart-shake",
                  !isAvailable && "bg-muted text-muted-foreground hover:bg-muted"
                )}
  ...
  return (
    ...
    >
      ...
      <div className="aspect-[4/3] overflow-hidden bg-secondary/20 relative shine-effect">
        ...
        {/* Unavailable Overlay */}
        {!isAvailable && (
          <div className="absolute inset-0 bg-foreground/60 flex flex-col items-center justify-center gap-1 z-20">
            <span className="bg-destructive text-destructive-foreground px-3 py-1 rounded-full text-xs font-bold">
              Out of Stock
            </span>
            <span className="text-[10px] text-white/90 font-medium">Will arrive soon</span>
          </div>
        )}
