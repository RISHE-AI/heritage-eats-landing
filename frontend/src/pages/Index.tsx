...
const Index: React.FC = () => {
  ...
  // Listen for wishlist product clicks (from WishlistSheet in Header)
  useEffect(() => {
    const handler = (e: Event) => {
      const product = (e as CustomEvent).detail;
      if (product) handleProductClick(product);
    };
    window.addEventListener("wishlist-product-click", handler);
    return () => window.removeEventListener("wishlist-product-click", handler);
  }, []);
