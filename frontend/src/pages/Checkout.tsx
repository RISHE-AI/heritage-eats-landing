...
const Checkout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-background page-enter pb-safe-bottom overflow-x-hidden">
      <Header />
      <div className="w-full px-3 sm:px-6 py-4 sm:py-6 md:py-10 max-w-6xl mx-auto overflow-hidden">
        {/* Step Progress */}
        ...
        <div className="grid gap-6 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2 space-y-4 min-w-0">
            <Card className="rounded-2xl shadow-card overflow-hidden max-w-full">
                  ...
                  <div key={`${item.product.id}-${item.selectedWeight}`} className="p-2.5 sm:p-3 rounded-xl bg-secondary/20 border border-border/30">
                    ...
                    <div className="flex items-start gap-2.5 sm:gap-3">
                      <img
                        ...
                        className="h-14 w-14 sm:h-16 sm:w-16 rounded-lg object-cover shadow-sm shrink-0"
                      />
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center justify-between mt-2 gap-1 sm:gap-2 flex-wrap">
                          <div className="flex items-center bg-background rounded-lg border border-border h-8">
                            <button
                              ...
                              className="h-7 w-7 sm:h-8 sm:w-8 flex items-center justify-center rounded-l-lg hover:bg-muted transition-colors disabled:opacity-40"
                            ...
                            <button
                              onClick={() => updateQuantity(item.product.id, item.selectedWeight, item.quantity + 1)}
                              className="h-7 w-7 sm:h-8 sm:w-8 flex items-center justify-center rounded-r-lg hover:bg-muted transition-colors"
